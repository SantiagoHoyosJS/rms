...
# imagenLamina = tk.PhotoImage(file="imagenes/admin/menu/tAddPlato.png") #Cambiar Imagen
...
labelIngre.place(x=720, y = 100)

txtIngre = tk.Text(ventana, width = 32, height=8, bg="lightgrey")
txtIngre.place(x=720, y = 170)

#Boton
def mGuardar() -> None:
    pass

guardar = tk.Button(ventana, command=mGuardar, bg="blue", text="Guardar cambions", width=32, height=3,foreground="white")
